...
*Sürüm kimliği: repo `rubicanjr/quant4h` · Aşama 11 kapanışı 2026-09-17 · suite 230/230 · statü: **watch_only (araştırma-kapalı)***
...
| Doğrulama | ön-kayıtlı split'ler (v1.1, frozen sha256) · look-ahead silme testleri her katmanda · 230 regresyon testi · TEST tek look | `scripts/register_splits.py`, `run_stage9.py` |
...
for t in tests/test_*.py; do .venv/bin/python -W ignore $t; done   # 230/230 beklenir
